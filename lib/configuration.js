(function() {
  ...
  module.exports = Configuration = (function() {
    ...
    Configuration.optionNames = ["bin", "dstPort", "httpPort", "dnsPort", "timeout", "workers", "procfile", "domains", "extDomains", "hostRoot", "logRoot", "rvmPath"];
    function Configuration(options) {
      var _base, _base2, _ref, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref21, _ref22, _ref23, _ref24, _ref25, _ref26, _ref27, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (options == null) {
        options = {};
      }
      ...
      this.procfile = (_ref13 = (_ref14 = options.procfile) != null ? _ref14 : env.POW_PROCFILE) != null ? _ref13 : "Procfile";
      this.domains = (_ref15 = (_ref16 = (_ref17 = options.domains) != null ? _ref17 : env.POW_DOMAINS) != null ? _ref16 : env.POW_DOMAIN) != null ? _ref15 : "dev";
      this.extDomains = (_ref18 = (_ref19 = options.extDomains) != null ? _ref19 : env.POW_EXT_DOMAINS) != null ? _ref18 : [];
      this.domains = (_ref20 = typeof (_base = this.domains).split === "function" ? _base.split(",") : void 0) != null ? _ref20 : this.domains;
      this.extDomains = (_ref21 = typeof (_base2 = this.extDomains).split === "function" ? _base2.split(",") : void 0) != null ? _ref21 : this.extDomains;
      this.allDomains = this.domains.concat(this.extDomains);
      this.hostRoot = (_ref22 = (_ref23 = options.hostRoot) != null ? _ref23 : env.POW_HOST_ROOT) != null ? _ref22 : libraryPath("Application Support", "Pow", "Hosts");
      this.logRoot = (_ref24 = (_ref25 = options.logRoot) != null ? _ref25 : env.POW_LOG_ROOT) != null ? _ref24 : libraryPath("Logs", "Pow");
      this.rvmPath = (_ref26 = (_ref27 = options.rvmPath) != null ? _ref27 : env.POW_RVM_PATH) != null ? _ref26 : path.join(env.HOME, ".rvm/scripts/rvm");
      this.loggers = {};
