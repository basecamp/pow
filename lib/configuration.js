(function() {
  var Configuration, Logger, async, compilePattern, fs, getFilenamesForHost, libraryPath, mkdirp, path, sourceScriptEnv;
  ...
  module.exports = Configuration = (function() {
    ...
    Configuration.optionNames = ["bin", "dstPort", "httpPort", "dnsPort", "timeout", "workers", "domains", "hostRoot", "logRoot", "rvmPath"];
    function Configuration(options) {
      ...
      this.timeout = (_ref9 = (_ref10 = options.timeout) != null ? _ref10 : process.env['POW_TIMEOUT']) != null ? _ref9 : 15 * 60;
      ...
      this.loggers = {};
      this.domainPattern = compilePattern(this.domains);
    }
