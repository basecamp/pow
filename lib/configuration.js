(function() {
  ...
  module.exports = Configuration = (function() {
    Configuration.globalConfigurationPath = path.join(process.env['HOME'], ".powconfig");
    Configuration.getGlobalConfigurationEnv = function(callback) {
      var p;
      return path.exists(p = this.globalConfigurationPath, function(exists) {
        if (exists) {
    ...
    Configuration.getGlobalConfiguration = function(callback) {
      return this.getGlobalConfigurationEnv(function(err, env) {
        var key, value;
        if (err) {
          return callback(err);
        } else {
    ...
    function Configuration(options) {
      var domain, _ref, _ref10, _ref11, _ref12, _ref13, _ref14, _ref15, _ref16, _ref17, _ref18, _ref19, _ref2, _ref20, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (options == null) {
        options = {};
      }
      this.dstPort = (_ref = (_ref2 = options.dstPort) != null ? _ref2 : process.env['POW_DST_PORT']) != null ? _ref : 80;
      this.httpPort = (_ref3 = (_ref4 = options.httpPort) != null ? _ref4 : process.env['POW_HTTP_PORT']) != null ? _ref3 : 20559;
      this.dnsPort = (_ref5 = (_ref6 = options.dnsPort) != null ? _ref6 : process.env['POW_DNS_PORT']) != null ? _ref5 : 20560;
      this.timeout = (_ref7 = (_ref8 = options.timeout) != null ? _ref8 : process.env['POW_TIMEOUT']) != null ? _ref7 : 15 * 60 * 1000;
      this.workers = (_ref9 = (_ref10 = options.workers) != null ? _ref10 : process.env['POW_WORKERS']) != null ? _ref9 : 2;
      domain = (_ref11 = (_ref12 = options.domain) != null ? _ref12 : process.env['POW_DOMAIN']) != null ? _ref11 : "test";
      this.domains = (_ref13 = (_ref14 = options.domains) != null ? _ref14 : process.env['POW_DOMAINS']) != null ? _ref13 : domain;
      this.domains = this.domains.split ? this.domains.split(",") : this.domains;
      this.hostRoot = (_ref15 = (_ref16 = options.hostRoot) != null ? _ref16 : process.env['POW_HOST_ROOT']) != null ? _ref15 : libraryPath("Application Support", "Pow", "Hosts");
      this.logRoot = (_ref17 = (_ref18 = options.logRoot) != null ? _ref18 : process.env['POW_LOG_ROOT']) != null ? _ref17 : libraryPath("Logs", "Pow");
      this.rvmPath = (_ref19 = (_ref20 = options.rvmPath) != null ? _ref20 : process.env['POW_RVM_PATH']) != null ? _ref19 : path.join(process.env.HOME, ".rvm/scripts/rvm");
      this.loggers = {};
    }
