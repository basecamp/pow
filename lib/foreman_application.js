(function() {
  ...
  module.exports = ForemanApplication = (function() {
    ...
    ForemanApplication.prototype.queryRestartFile = function(callback) {
    ...
    ForemanApplication.prototype.initialize = function() {
      ...
      return this.loadEnvironment(__bind(function(err, env) {
        ...
        if (err) {
          ...
          basePort = void 0;
          tmpServer.on('close', __bind(function() {
            this.foreman = spawn('foreman', ['start', '-f', this.procfile, '-p', basePort], {
              cwd: this.root,
              env: env
            });
          ...
          return tmpServer.listen(0, __bind(function() {
            basePort = tmpServer.address().port;
            return tmpServer.close();
          }, this));
        }
      }, this));
    };
    ...
    ForemanApplication.prototype.terminate = function() {
      ...
      if (this.state === "initializing") {
        ...
        if (this.foreman) {
          ...
          this.logger.debug("Sending SIGTERM to " + this.foreman.pid);
          this.foreman.kill('SIGTERM');
          return timeout = setTimeout(__bind(function() {
            if (this.state === 'terminating') {
              this.logger.debug("Sending SIGKILL to " + this.foreman.pid);
    ...
    ForemanApplication.prototype.restartIfNecessary = function(callback) {
