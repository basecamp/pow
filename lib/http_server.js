(function() {
  var HttpServer, PowConsole, RackApplication, connect, dirname, exists, fs, join, pause, sys, _ref;
  ...
  module.exports = HttpServer = (function() {
    ...
    function HttpServer(configuration) {
      ...
      this.handlePowConsoleRequest = __bind(this.handlePowConsoleRequest, this);;
      this.annotateRequest = __bind(this.annotateRequest, this);;
      this.logRequest = __bind(this.logRequest, this);;
      HttpServer.__super__.constructor.call(this, [o(this.logRequest), o(this.annotateRequest), o(this.handlePowConsoleRequest), o(this.findApplicationRoot), o(this.handleStaticRequest), o(this.findRackApplication), o(this.handleApplicationRequest), x(this.handleApplicationException)]);
      this.staticHandlers = {};
      this.rackApplications = {};
      this.powConsole = new PowConsole(this.configuration, this);
    ...
    HttpServer.prototype.handlePowConsoleRequest = function(req, res, next) {
      if (req.pow.hostWithoutDomain === "pow") {
        this.powConsole.handle(req, res, next);
        return this.debugLog.debug("sent request to @powConsole");
      } else {
        return next();
      }
    };
