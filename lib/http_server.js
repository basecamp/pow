(function() {
  var HttpProxy, HttpServer, RackApplication, connect, dirname, exists, fs, join, pause, sys, version, _ref;
  ...
  module.exports = HttpServer = (function() {
    ...
    function HttpServer(configuration) {
      ...
      HttpServer.__super__.constructor.call(this, [o(this.logRequest), o(this.annotateRequest), o(this.handlePowRequest), o(this.findApplicationRoot), o(this.handleStaticRequest), o(this.findRackApplication), o(this.handleProxyRequest), o(this.handleApplicationRequest), x(this.handleErrorStartingApplication), o(this.handleFaviconRequest), o(this.handleApplicationNotFound), o(this.handleWelcomeRequest), o(this.handleRailsAppWithoutRackupFile), o(this.handleLocationNotFound)]);
      this.staticHandlers = {};
    ...
    HttpServer.prototype.handleProxyRequest = function(req, res, next) {
      var port, _ref2;
      if (!((port = req.pow.root) && typeof port === "number")) {
        return next();
      }
