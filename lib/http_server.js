...
(function() {
  ...
  module.exports = HttpServer = (function(_super) {
    ...
    HttpServer.prototype.runningApps = function() {
      var apps, rootPath;

      apps = [];
      for (rootPath in this.rackApplications) {
        apps.push(this.rackApplications[rootPath]);
      }
      return apps;
    };
    ...
    HttpServer.prototype.handlePowRequest = function(req, res, next) {
      ...
      switch (req.url) {
        ...
        case "/apps.json":
          res.writeHead(200);
          return res.end(JSON.stringify(this.runningApps()));
        default:
