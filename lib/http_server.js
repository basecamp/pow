...
(function() {
  var HttpServer, RackApplication, connect, dirname, exists, existsSync, fs, join, pause, request, url, version, _ref,
  ...
  _ref = require("path"), dirname = _ref.dirname, join = _ref.join, exists = _ref.exists, existsSync = _ref.existsSync;
  ...
  module.exports = HttpServer = (function(_super) {
    ...
    HttpServer.prototype.handleStaticRequest = function(req, res, next) {
      var handler, root, static_path, _base, _ref1, _ref2;
      ...
      static_path = function() {
        if (existsSync(join(root, ".powstatic"))) {
          return root;
        } else {
          return join(root, "public");
        }
      };
      handler = (_ref2 = (_base = this.staticHandlers)[root]) != null ? _ref2 : _base[root] = connect["static"](static_path());
