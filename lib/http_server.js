(function() {
  ...
  module.exports = HttpServer = (function() {
    ...
    function HttpServer(configuration) {
      ...
      HttpServer.__super__.constructor.call(this, [o(this.logRequest), o(this.annotateRequest), o(this.findApplicationRoot), o(this.handleStaticRequest), o(this.findRackApplication), o(this.handleApplicationRequest), x(this.handleErrorStartingApplication), o(this.handleFaviconRequest), o(this.handleApplicationNotFound), o(this.handleWelcomeRequest), o(this.handleRailsAppWithoutRackupFile), o(this.handleLocationNotFound)]);
      this.staticHandlers = {};
    ...
    HttpServer.prototype.handleApplicationNotFound = function(req, res, next) {
      var domain, host, name, _ref2;
      if (req.pow.root) {
        return next();
      }
      host = req.pow.host;
      if (!(domain = host != null ? (_ref2 = host.match(this.configuration.domainPattern)) != null ? _ref2[1] : void 0 : void 0)) {
        return next();
      }
