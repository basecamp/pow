(function() {
  ...
  module.exports = HttpServer = (function() {
    ...
    function HttpServer(configuration) {
      ...
      this.handleWelcome = __bind(this.handleWelcome, this);;
      this.handleLocationNotFound = __bind(this.handleLocationNotFound, this);;
      this.handleDomainNotFound = __bind(this.handleDomainNotFound, this);;
      ...
      HttpServer.__super__.constructor.call(this, [o(this.logRequest), o(this.annotateRequest), o(this.findApplicationRoot), o(this.handleStaticRequest), o(this.findRackApplication), o(this.handleApplicationRequest), x(this.handleApplicationException), o(this.handleDomainNotFound), o(this.handleLocationNotFound), o(this.handleWelcome)]);
      this.staticHandlers = {};
    ...
    HttpServer.prototype.handleDomainNotFound = function(req, res, next) {
    ...
    HttpServer.prototype.handleWelcome = function(req, res, next) {
      return this.render(res, 200, "welcome", {
        version: "0.3.0"
      });
    };
