(function() {
  var Installer, InstallerFile, async, chown, daemonSource, fs, mkdirp, path, resolverSource, spawn, startupItemSource, startupParametersSource, sys;
  ...
  chown = function(path, owner, callback) {
    var chown, error;
    error = "";
  ...
  module.exports = Installer = (function() {
    Installer.getSystemInstaller = function(configuration) {
      ...
      files = [new InstallerFile("/Library/StartupItems/PowFirewallRules/PowFirewallRules", startupItemSource(this.configuration), true), new InstallerFile("/Library/StartupItems/PowFirewallRules/StartupParameters.plist", startupParametersSource(this.configuration), true)];
