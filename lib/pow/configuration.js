(function() {
  ...
  module.exports = Configuration = (function() {
    function Configuration(options) {
      ...
      this.domain = (_ref6 = options.domain) != null ? _ref6 : "test";
      this.root = (_ref7 = options.root) != null ? _ref7 : path.join(process.env.HOME, ".pow");
      this.logRoot = (_ref8 = options.logRoot) != null ? _ref8 : path.join(this.root, ".log");
      this.loggers = {};
    }
    ...
    Configuration.prototype.findApplicationRootForHost = function(host, callback) {
      return this.gatherApplicationRoots(__bind(function(err, roots) {
        ...
        _ref = getFilenamesForHost(host, this.domain);
