(function() {
  ...
  module.exports = HttpServer = (function() {
    ...
    function HttpServer(configuration) {
      ...
      HttpServer.__super__.constructor.call(this, [o(this.logRequest), o(this.handleRackRequest), x(this.handleApplicationException), o(this.handleNonexistentDomain)]);
      this.rackHandlers = {};
      this.staticHandlers = {};
