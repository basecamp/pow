(function() {
  var HttpServer, RackHandler, connect, dirname, escapeHTML, exec, fs, getHost, join, o, pause, sys, x, _ref;
  ...
  module.exports = HttpServer = (function() {
    ...
    function HttpServer(configuration) {
      ...
      HttpServer.__super__.constructor.call(this, [o(this.logRequest), o(this.handleRequest), x(this.handleApplicationException), o(this.handleNonexistentDomain)]);
      this.handlers = {};
    ...
    HttpServer.prototype.getHandlerForRoot = function(root, callback) {
      ...
      if (!root) {
        return callback();
      } else if (handler = this.handlers[root]) {
        return callback(null, handler);
      } else {
        return this.handlers[root] = new RackHandler(this.configuration, root, callback);
      }
    };
