(function() {
  var HttpServer, connect, fs, getHost, join, nack, o, sys, x;
  ...
  module.exports = HttpServer = (function() {
    ...
    function HttpServer(configuration) {
      ...
      this.handleException = __bind(this.handleException, this);;
      this.closeApplications = __bind(this.closeApplications, this);;
      this.handleRequest = __bind(this.handleRequest, this);;
      HttpServer.__super__.constructor.call(this, [o(this.handleRequest), x(this.handleException), o(this.handleNonexistentDomain)]);
      this.handlers = {};
    ...
    HttpServer.prototype.handleException = function(err, req, res, next) {
      var host, name, path;
      host = getHost(req);
