(function() {
  var LineBuffer, RackHandler, basename, bufferLines, dirname, exec, fs, getEnvForRoot, join, nack, pause, sourceScriptEnv, _ref, _ref2;
  var __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
  fs = require("fs");
  nack = require("nack");
  _ref = require("nack/util"), LineBuffer = _ref.LineBuffer, pause = _ref.pause;
