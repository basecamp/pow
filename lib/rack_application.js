...
(function() {
  var RackApplication, async, basename, bufferLines, fs, join, nack, pause, quote, resolve, sourceScriptEnv, _ref, _ref1;
  ...
  _ref = require("./util"), bufferLines = _ref.bufferLines, pause = _ref.pause, sourceScriptEnv = _ref.sourceScriptEnv, quote = _ref.quote;
  ...
  module.exports = RackApplication = (function() {
    ...
    RackApplication.prototype.loadScriptEnvironment = function(env, callback) {
      var before, envFiles, home,
        _this = this;

      home = process.env["HOME"];
      envFiles = [join(home, ".powrc"), join(this.root, ".powrc"), join(this.root, ".envrc"), join(this.root, ".powenv")];
      before = "cd " + (quote(this.root));
      return async.reduce(envFiles, env, function(env, script, callback) {
        return fs.exists(script, function(scriptExists) {
          if (scriptExists) {
