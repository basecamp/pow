...
(function() {
  ...
  module.exports = RackApplication = (function() {
    ...
    RackApplication.prototype.toJSON = function() {
      return {
        root: this.root,
        host: this.firstHost,
        startedAt: Math.round(this.started / 1000),
        lastRestartedAt: Math.round(this.mtime / 1000),
        lastRequestAt: Math.round(this.lastRequestTime / 1000),
        requestCount: this.requestCount,
        timeout: Math.round(this.timeout / 1000),
        mightIdleAt: Math.round((this.lastRequestTime + this.timeout) / 1000),
        status: ((+(new Date)) - this.lastRequestTime) > this.timeout ? 'idle' : 'active'
      };
    };
    ...
    RackApplication.prototype.initialize = function() {
      ...
      return this.loadEnvironment(function(err, env) {
        ...
        if (err) {
          ...
          _this.timeout = ((_ref2 = env != null ? env.POW_TIMEOUT : void 0) != null ? _ref2 : _this.configuration.timeout) * 1000;
      ...
      return this.ready(function(err) {
        ...
        return _this.setPoolRunOnceFlag(function() {
          return _this.restartIfNecessary(function() {
            ...
            try {
              _this.lastRequestTime = +(new Date);
              _this.requestCount++;
