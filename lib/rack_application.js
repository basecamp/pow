(function() {
  ...
  module.exports = RackApplication = (function() {
    ...
    RackApplication.prototype.queryAlwaysRestartFile = function(callback) {
      return fs.stat(join(this.root, "tmp/always_restart.txt"), __bind(function(err, stats) {
        if (err) {
          return callback(false);
        } else {
          if (this.flagForAlwaysRestart) {
    ...
    RackApplication.prototype.terminate = function() {
      if (this.state === "initializing") {
        ...
        return this.pool.quit(__bind(function() {
          var quitCallback, _i, _len, _ref;
          this.state = null;
          this.mtime = null;
          this.pool = null;
          _ref = this.quitCallbacks;
          for (_i = 0, _len = _ref.length; _i < _len; _i++) {
            quitCallback = _ref[_i];
            quitCallback();
          }
