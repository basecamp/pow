(function() {
  ...
  exports.PortChecker = PortChecker = (function() {
    ...
    function PortChecker(name, port, retryTimeout) {
      ...
      this.port = port;
      this.errors = 0;
      this.connect(retryTimeout);
    }
    PortChecker.prototype.connect = function(retryTimeout) {
      var connection;
      ...
      return connection.on('error', __bind(function(exception) {
        ...
        if (this.errors < 3) {
          return setTimeout(__bind(function() {
            return this.connect(retryTimeout * 2);
          }, this), retryTimeout);
        } else {
