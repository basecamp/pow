...
(function() {
  var LineBuffer, Stream, async, exec, execFile, fs, getUserLocale, getUserShell, loginExec, makeTemporaryFilename, parseEnv, path, quote, readAndUnlink, spawn,
  ...
  exports.sourceScriptEnv = function(script, env, options, callback) {
    ...
    return execFile("/usr/bin/env", ["bash", "-c", command], {
      cwd: cwd,
      env: env
