...
# possible. You can install it in ten seconds and have your first app
# up and running in under a minute. No mucking around with
# `/etc/hosts`, no compiling Apache modules, no editing configuration
# files or installing preference panes. And running multiple apps with
# multiple versions of Ruby is trivial.
#
